...
if ((place_meeting(x, y + 1, obj_collisionparent) && vsp > 0) && key_attack && momemtum == 1 && sprite_index == spr_player_fall2) {
	landAnim = 0;
	state = 48;
	jumpAnim = 1;
	jumpstop = 0;
...
if ((place_meeting(x, y + 1, obj_collisionparent) && vsp > 0) && (!key_attack || momemtum == 0) && sprite_index == spr_player_fall2) {
	if (key_attack)
		landAnim = 0;
